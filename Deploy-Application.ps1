...
Try {
    ...
    [string]$appVendor = ''
    [string]$appName = 'Maxima'
    [string]$appVersion = '5.47.0'
    [string]$appArch = 'x64'
    [string]$appLang = 'EN'
    ...
    If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
        ...
        Show-InstallationWelcome -CloseApps 'wxmaxima,maxima' -CheckDiskSpace -PersistPrompt
        ...
        Execute-Process -Path "$dirFiles/maxima-5.47.0-win64.exe" -Parameters "/S"
        ...
        Copy-Item "$dirSupportFiles\wxMaxima (GUI for Maxima).lnk" -Destination "$envCommonDesktop" -Force
    ...
    ElseIf ($deploymentType -ieq 'Uninstall') {
        ...
        Show-InstallationWelcome -CloseApps 'wxmaxima,maxima' -CloseAppsCountdown 60

        ## Show Progress Message (with the default message)
        Show-InstallationProgress

        ## <Perform Pre-Uninstallation tasks here>
        Remove-Item "$envCommonDesktop\wxMaxima (GUI for Maxima).lnk"
        ...
        Execute-Process -Path "C:\maxima-5.47.0\Uninstall.exe" -Parameters "/S"
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCMUW96MqBTkT/p
# 9f0SXdQBTvDZzGJa7nJ27vQSmE0qFKCCH8AwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# gjcCAQsxDjAMBgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCDQiCuf6EgGCXHC
# 7EobxCqKcOuGgZW1zhEwaDng+CvbqjANBgkqhkiG9w0BAQEFAASCAYB7nJuO25Wn
# rrtqH4Dz5RMlYsGaIhWvJFJihm1ObP2wv+XMpCqcHwrcCcbubVrvBpxtw8AUa4PX
# Ust0ZDVglUwgieOuPugP8tJtgViYk2ouNuw45KP3Eg2kMfayFObnFmZuEF+8ZQEk
# 3KvoYBk4QIqOAvguSeELVFjHf91lnGJRtGNUCyyYr6Ra/b1dSbCg6HpVK09EOpjP
# QJUJE5xqno5HLMt5wmi1VRLcBirdcK5ooDZ559QYhcDTZ+XcKcxR/GQHU+kvkyc/
# Hgu0MX5GzP0wZgxEN4VTqy3HGR21DXTTM60E40ATkuk0OwMTrU9LXAlGG/hOgiA6
# 4gYpILYfAfBgc+qtYOainckb1XPZNRzBad8D9RNX+qikwPWFmQvC+2k02lb/X2kz
# xQStM5DqjA5idYgCI/KAYe9aax4hjAaMk8q3t/mynT0UbjTWbCwSximavfuhrUFS
# LhTABwrVSIDik9iRBA8eh/0YEy+Fg9+0uQsNb3pS5jqgopHNZjA6z7ahggNLMIID
...
# MzQ3WjA/BgkqhkiG9w0BCQQxMgQwtnrSqs2TLntl2E5dRjbwP0cff1eUQaP0nwgi
# WqQK7udhC8fgwrrKyI3wWYXOUgTAMA0GCSqGSIb3DQEBAQUABIICAID5Ugg4psiY
# 0kvEDJsnvkUY1OQPDiZHNwCRvY9wRlwHOZp3pu38Ty/9WsGc7O6g93O57i9yf7kR
# 0TQfZgsf9JrQ+lseRDa7tLiWSf8Nioq5XILkSA2ICN0oY5NRCwS3it/fDYHoJ2c7
# xeKzCgC1yfJ/DUzJahUnWG8H3W93Tk8sukE75286UCSY/m5ogDiNsAEwXyd+qGYb
# jMIJpM03fCIHtAteyWVMQfhHXMZNNGYffJfNJOVmX8tgB2e7k1sJzcP6+yLo0yxv
# T+6vEJ1rtmCOM+8fxI9xsE/OmHb9xoMUHbF9CcJzqQzUJ3B2NlKSIZNnrEE7ujHd
# A85757+38CRSXCCF1/aCQg6mjMjiB8Cm8106sN/tFDBnlNtw213k+pfsQfkQenli
# A23hf7VxvaPuoQIkJSA1Kz4bFW74zmOcgh97z2JiOxLKPjdPzy4WlH1iVD8iJ5cH
# IH1yX6r+U1HwBRkWvJbvViTH5q8Xad4v1F7tOovsR8N+eBPcJlus2cZNFuI+KLXN
# 0rC4HKJCRSxtzgWC8jKRTI93b2Z2E6ZlFWlU9X2x83IakyVvCdsHUyy3f/WpU3yr
# 08+4cseKiDpL4XpylK5qS3ZVUPiXWUZlLilIYsDK1whOnYwebzYlft54tF2sm1rd
# SaIiKfIaS45DZpNKPWQo/SQ+BmhNl77X
